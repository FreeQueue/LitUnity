...
namespace glm
{
	...
	template <length_t C, length_t R, typename T, qualifier Q>
	GLM_FUNC_QUALIFIER void qr_decompose(const mat<C, R, T, Q>& in, mat<(C < R ? C : R), R, T, Q>& q,
										mat<C, (C < R ? C : R), T, Q>& r)
	{
	...
	template <length_t C, length_t R, typename T, qualifier Q>
	GLM_FUNC_QUALIFIER void rq_decompose(const mat<C, R, T, Q>& in, mat<(C < R ? C : R), R, T, Q>& r,
										mat<C, (C < R ? C : R), T, Q>& q)
	{
