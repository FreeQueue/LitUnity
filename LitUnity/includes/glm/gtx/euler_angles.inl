...
namespace glm
{
	...
	template <typename T>
	GLM_FUNC_DECL void extractEulerAngleXYZ(const mat<4, 4, T, defaultp>& M,
											T& t1,
											T& t2,
											T& t3)
	{
	...
	template <typename T>
	GLM_FUNC_QUALIFIER void extractEulerAngleYXZ(const mat<4, 4, T, defaultp>& M,
												T& t1,
												T& t2,
												T& t3)
	{
	...
	template <typename T>
	GLM_FUNC_QUALIFIER void extractEulerAngleXZX(const mat<4, 4, T, defaultp>& M,
												T& t1,
												T& t2,
												T& t3)
	{
	...
	template <typename T>
	GLM_FUNC_QUALIFIER void extractEulerAngleXYX(const mat<4, 4, T, defaultp>& M,
												T& t1,
												T& t2,
												T& t3)
	{
	...
	template <typename T>
	GLM_FUNC_QUALIFIER void extractEulerAngleYXY(const mat<4, 4, T, defaultp>& M,
												T& t1,
												T& t2,
												T& t3)
	{
	...
	template <typename T>
	GLM_FUNC_QUALIFIER void extractEulerAngleYZY(const mat<4, 4, T, defaultp>& M,
												T& t1,
												T& t2,
												T& t3)
	{
	...
	template <typename T>
	GLM_FUNC_QUALIFIER void extractEulerAngleZYZ(const mat<4, 4, T, defaultp>& M,
												T& t1,
												T& t2,
												T& t3)
	{
	...
	template <typename T>
	GLM_FUNC_QUALIFIER void extractEulerAngleZXZ(const mat<4, 4, T, defaultp>& M,
												T& t1,
												T& t2,
												T& t3)
	{
	...
	template <typename T>
	GLM_FUNC_QUALIFIER void extractEulerAngleXZY(const mat<4, 4, T, defaultp>& M,
												T& t1,
												T& t2,
												T& t3)
	{
	...
	template <typename T>
	GLM_FUNC_QUALIFIER void extractEulerAngleYZX(const mat<4, 4, T, defaultp>& M,
												T& t1,
												T& t2,
												T& t3)
	{
	...
	template <typename T>
	GLM_FUNC_QUALIFIER void extractEulerAngleZYX(const mat<4, 4, T, defaultp>& M,
												T& t1,
												T& t2,
												T& t3)
	{
	...
	template <typename T>
	GLM_FUNC_QUALIFIER void extractEulerAngleZXY(const mat<4, 4, T, defaultp>& M,
												T& t1,
												T& t2,
												T& t3)
	{
