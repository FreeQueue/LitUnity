...
namespace glm
{
	...
	(
		...
		const genType& planeOrig, const genType& planeNormal,
	...
	(
		const vec<3, T, Q>& orig, const vec<3, T, Q>& dir,
		const vec<3, T, Q>& vert0, const vec<3, T, Q>& vert1, const vec<3, T, Q>& vert2,
	...
	(
		const genType& rayStarting, const genType& rayNormalizedDirection,
		const genType& sphereCenter, const typename genType::value_type sphereRadiusSquered,
		typename genType::value_type& intersectionDistance
	)
	{
		typename genType::value_type Epsilon = std::numeric_limits<typename genType::value_type>::epsilon();
	...
	(
		const genType& rayStarting, const genType& rayNormalizedDirection,
		const genType& sphereCenter, const typename genType::value_type sphereRadius,
	...
	(
		...
		const genType& sphereCenter, typename genType::value_type sphereRadius,
