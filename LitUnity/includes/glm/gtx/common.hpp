...
namespace glm
{
	...
	template <length_t L, typename T, qualifier Q>
	GLM_FUNC_DECL vec<L, bool, Q> openBounded(const vec<L, T, Q>& Value, const vec<L, T, Q>& Min,
											const vec<L, T, Q>& Max);
	...
	/// @see ext_vector_relational
	template <length_t L, typename T, qualifier Q>
	GLM_FUNC_DECL vec<L, bool, Q> closeBounded(const vec<L, T, Q>& Value, const vec<L, T, Q>& Min,
												const vec<L, T, Q>& Max);
