...
namespace glm
{
	...
	public:
		...
		GLM_FUNC_DECL GLM_CONSTEXPR mat(const mat<3, 4, T, P>& m);
		...
		GLM_FUNC_DECL GLM_EXPLICIT GLM_CONSTEXPR mat(const mat<3, 4, U, P>& m);
		...
		template <typename U>
		GLM_FUNC_DECL mat<3, 4, T, Q>& operator=(const mat<3, 4, U, Q>& m);
		template <typename U>
	...
	template <typename T, qualifier Q>
	GLM_FUNC_DECL mat<3, 4, T, Q> operator+(const mat<3, 4, T, Q>& m);
	...
	template <typename T, qualifier Q>
	GLM_FUNC_DECL mat<3, 4, T, Q> operator+(const mat<3, 4, T, Q>& m, T scalar);

	template <typename T, qualifier Q>
	GLM_FUNC_DECL mat<3, 4, T, Q> operator+(const mat<3, 4, T, Q>& m1, const mat<3, 4, T, Q>& m2);
	...
	template <typename T, qualifier Q>
	GLM_FUNC_DECL mat<3, 4, T, Q> operator*(T scalar, const mat<3, 4, T, Q>& m);

	template <typename T, qualifier Q>
	GLM_FUNC_DECL typename mat<3, 4, T, Q>::col_type operator*(const mat<3, 4, T, Q>& m,
																const typename mat<3, 4, T, Q>::row_type& v);

	template <typename T, qualifier Q>
	GLM_FUNC_DECL typename mat<3, 4, T, Q>::row_type operator*(const typename mat<3, 4, T, Q>::col_type& v,
																const mat<3, 4, T, Q>& m);

	template <typename T, qualifier Q>
	GLM_FUNC_DECL mat<4, 4, T, Q> operator*(const mat<3, 4, T, Q>& m1, const mat<4, 3, T, Q>& m2);

	template <typename T, qualifier Q>
	GLM_FUNC_DECL mat<2, 4, T, Q> operator*(const mat<3, 4, T, Q>& m1, const mat<2, 3, T, Q>& m2);

	template <typename T, qualifier Q>
	GLM_FUNC_DECL mat<3, 4, T, Q> operator*(const mat<3, 4, T, Q>& m1, const mat<3, 3, T, Q>& m2);
	...
	template <typename T, qualifier Q>
	GLM_FUNC_DECL bool operator==(const mat<3, 4, T, Q>& m1, const mat<3, 4, T, Q>& m2);
