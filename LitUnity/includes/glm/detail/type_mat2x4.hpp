...
namespace glm
{
	...
	template <typename T, qualifier Q>
	GLM_FUNC_DECL typename mat<2, 4, T, Q>::col_type operator*(const mat<2, 4, T, Q>& m,
																const typename mat<2, 4, T, Q>::row_type& v);

	template <typename T, qualifier Q>
	GLM_FUNC_DECL typename mat<2, 4, T, Q>::row_type operator*(const typename mat<2, 4, T, Q>::col_type& v,
																const mat<2, 4, T, Q>& m);
