...
#	endif
		...
		{
			GLM_FUNC_QUALIFIER static vec<L, T, Q> call(const vec<L, T, Q>& x, const vec<L, T, Q>& minVal,
														const vec<L, T, Q>& maxVal)
			{
		...
		{
			GLM_FUNC_QUALIFIER static vec<L, T, Q> call(const vec<L, T, Q>& edge0, const vec<L, T, Q>& edge1,
														const vec<L, T, Q>& x)
			{
	...
	template <length_t L, typename T, qualifier Q>
	GLM_FUNC_QUALIFIER vec<L, T, Q> sign(const vec<L, T, Q>& x)
	{
		GLM_STATIC_ASSERT(
...
#		endif
	...
	template <length_t L, typename T, qualifier Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, T, Q> clamp(const vec<L, T, Q>& x, const vec<L, T, Q>& minVal,
														const vec<L, T, Q>& maxVal)
	{
		GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559 || std::numeric_limits<T>::is_integer,
						"'clamp' only accept floating-point or integer inputs");
	...
	GLM_FUNC_QUALIFIER vec<L, T, Q> mix(const vec<L, T, Q>& x, const vec<L, T, Q>& y, U a)
	{
		return detail::compute_mix_scalar<L, T, U, Q, detail::is_aligned<Q>::value>::call(x, y, a);
	}

	template <length_t L, typename T, typename U, qualifier Q>
	GLM_FUNC_QUALIFIER vec<L, T, Q> mix(const vec<L, T, Q>& x, const vec<L, T, Q>& y, const vec<L, U, Q>& a)
	{
	...
	template <length_t L, typename T, qualifier Q>
	GLM_FUNC_QUALIFIER vec<L, T, Q> smoothstep(const vec<L, T, Q>& edge0, const vec<L, T, Q>& edge1,
												const vec<L, T, Q>& x)
	{
...
#	endif
	...
	GLM_FUNC_QUALIFIER int floatBitsToInt(const float& v)
	{
		union
		{
			float in;
	...
	GLM_FUNC_QUALIFIER uint floatBitsToUint(const float& v)
	{
		union
		{
			float in;
	...
	GLM_FUNC_QUALIFIER float intBitsToFloat(const int& v)
	{
		union
		{
			int in;
	...
	GLM_FUNC_QUALIFIER float uintBitsToFloat(const uint& v)
	{
		union
		{
			uint in;
