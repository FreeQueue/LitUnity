...
namespace glm
{
	...
	GLM_FUNC_QUALIFIER const T* value_ptr(const vec<2, T, Q>& v)
	{
		return &(v.x);
	}
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER const T* value_ptr(const vec<3, T, Q>& v)
	{
		return &(v.x);
	}
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER const T* value_ptr(const vec<4, T, Q>& v)
	{
		return &(v.x);
	}
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER const T* value_ptr(const mat<2, 2, T, Q>& m)
	{
		return &(m[0].x);
	}
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER const T* value_ptr(const mat<3, 3, T, Q>& m)
	{
		return &(m[0].x);
	}
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER const T* value_ptr(const mat<4, 4, T, Q>& m)
	{
		return &(m[0].x);
	}
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER const T* value_ptr(const mat<2, 3, T, Q>& m)
	{
		return &(m[0].x);
	}
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER const T* value_ptr(const mat<3, 2, T, Q>& m)
	{
		return &(m[0].x);
	}
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER const T* value_ptr(const mat<2, 4, T, Q>& m)
	{
		return &(m[0].x);
	}
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER const T* value_ptr(const mat<4, 2, T, Q>& m)
	{
		return &(m[0].x);
	}
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER const T* value_ptr(const mat<3, 4, T, Q>& m)
	{
		return &(m[0].x);
	}
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER const T* value_ptr(const mat<4, 3, T, Q>& m)
	{
		return &(m[0].x);
	}
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER const T* value_ptr(const qua<T, Q>& q)
	{
		return &(q[0]);
	}
	...
	template <typename T, qualifier Q>
	vec<1, T, Q> make_vec1(const vec<1, T, Q>& v)
	{
		return v;
	}

	template <typename T, qualifier Q>
	vec<1, T, Q> make_vec1(const vec<2, T, Q>& v)
	{
		return vec<1, T, Q>(v);
	}

	template <typename T, qualifier Q>
	vec<1, T, Q> make_vec1(const vec<3, T, Q>& v)
	{
		return vec<1, T, Q>(v);
	}

	template <typename T, qualifier Q>
	vec<1, T, Q> make_vec1(const vec<4, T, Q>& v)
	{
		return vec<1, T, Q>(v);
	}

	template <typename T, qualifier Q>
	vec<2, T, Q> make_vec2(const vec<1, T, Q>& v)
	{
		return vec<2, T, Q>(v.x, static_cast<T>(0));
	}

	template <typename T, qualifier Q>
	vec<2, T, Q> make_vec2(const vec<2, T, Q>& v)
	{
		return v;
	}

	template <typename T, qualifier Q>
	vec<2, T, Q> make_vec2(const vec<3, T, Q>& v)
	{
		return vec<2, T, Q>(v);
	}

	template <typename T, qualifier Q>
	vec<2, T, Q> make_vec2(const vec<4, T, Q>& v)
	{
		return vec<2, T, Q>(v);
	}

	template <typename T, qualifier Q>
	vec<3, T, Q> make_vec3(const vec<1, T, Q>& v)
	{
		return vec<3, T, Q>(v.x, static_cast<T>(0), static_cast<T>(0));
	}

	template <typename T, qualifier Q>
	vec<3, T, Q> make_vec3(const vec<2, T, Q>& v)
	{
		return vec<3, T, Q>(v.x, v.y, static_cast<T>(0));
	}

	template <typename T, qualifier Q>
	vec<3, T, Q> make_vec3(const vec<3, T, Q>& v)
	{
		return v;
	}

	template <typename T, qualifier Q>
	vec<3, T, Q> make_vec3(const vec<4, T, Q>& v)
	{
		return vec<3, T, Q>(v);
	}

	template <typename T, qualifier Q>
	vec<4, T, Q> make_vec4(const vec<1, T, Q>& v)
	{
		return vec<4, T, Q>(v.x, static_cast<T>(0), static_cast<T>(0), static_cast<T>(1));
	}

	template <typename T, qualifier Q>
	vec<4, T, Q> make_vec4(const vec<2, T, Q>& v)
	{
		return vec<4, T, Q>(v.x, v.y, static_cast<T>(0), static_cast<T>(1));
	}

	template <typename T, qualifier Q>
	vec<4, T, Q> make_vec4(const vec<3, T, Q>& v)
	{
		return vec<4, T, Q>(v.x, v.y, v.z, static_cast<T>(1));
	}

	template <typename T, qualifier Q>
	vec<4, T, Q> make_vec4(const vec<4, T, Q>& v)
	{
		return v;
	}
