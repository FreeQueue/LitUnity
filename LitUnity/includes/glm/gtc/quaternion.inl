...
namespace glm
{
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER vec<4, bool, Q> lessThan(const qua<T, Q>& x, const qua<T, Q>& y)
	{
		vec<4, bool, Q> Result;
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER vec<4, bool, Q> lessThanEqual(const qua<T, Q>& x, const qua<T, Q>& y)
	{
		vec<4, bool, Q> Result;
		for (length_t i = 0; i < x.length(); ++i)
			Result[i] = x[i] <= y[i];
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER vec<4, bool, Q> greaterThan(const qua<T, Q>& x, const qua<T, Q>& y)
	{
		vec<4, bool, Q> Result;
		for (length_t i = 0; i < x.length(); ++i)
			Result[i] = x[i] > y[i];
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER vec<4, bool, Q> greaterThanEqual(const qua<T, Q>& x, const qua<T, Q>& y)
	{
		vec<4, bool, Q> Result;
		for (length_t i = 0; i < x.length(); ++i)
			Result[i] = x[i] >= y[i];
