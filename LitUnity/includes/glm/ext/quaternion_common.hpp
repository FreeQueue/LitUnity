...
namespace glm
{
	...
	/// @tparam Q A value from qualifier enum
	template <typename T, qualifier Q>
	GLM_FUNC_DECL qua<T, Q> lerp(const qua<T, Q>& x, const qua<T, Q>& y, T a);
	...
	/// @tparam Q A value from qualifier enum
	template <typename T, qualifier Q>
	GLM_FUNC_DECL qua<T, Q> conjugate(const qua<T, Q>& q);
	...
	/// @tparam Q A value from qualifier enum
	template <typename T, qualifier Q>
	GLM_FUNC_DECL qua<T, Q> inverse(const qua<T, Q>& q);
