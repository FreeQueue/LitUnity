namespace glm
{
	...
	GLM_FUNC_QUALIFIER mat<4, 4, T, Q> translate(const mat<4, 4, T, Q>& m, const vec<3, T, Q>& v)
	{
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER mat<4, 4, T, Q> lookAtRH(const vec<3, T, Q>& eye, const vec<3, T, Q>& center,
												const vec<3, T, Q>& up)
	{
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER mat<4, 4, T, Q> lookAtLH(const vec<3, T, Q>& eye, const vec<3, T, Q>& center,
												const vec<3, T, Q>& up)
	{
		const vec<3, T, Q> f(normalize(center - eye));
	...
	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER mat<4, 4, T, Q> lookAt(const vec<3, T, Q>& eye, const vec<3, T, Q>& center,
											const vec<3, T, Q>& up)
	{
		GLM_IF_CONSTEXPR (false)
