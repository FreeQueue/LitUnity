...
namespace glm
{
	...
	GLM_FUNC_DECL vec<3, T, Q> projectZO(
		const vec<3, T, Q>& obj, const mat<4, 4, T, Q>& model, const mat<4, 4, T, Q>& proj,
	...
	GLM_FUNC_DECL vec<3, T, Q> unProjectZO(
		const vec<3, T, Q>& win, const mat<4, 4, T, Q>& model, const mat<4, 4, T, Q>& proj,
		const vec<4, U, Q>& viewport);
	...
	GLM_FUNC_DECL mat<4, 4, T, Q> pickMatrix(
		const vec<2, T, Q>& center, const vec<2, T, Q>& delta, const vec<4, U, Q>& viewport);
